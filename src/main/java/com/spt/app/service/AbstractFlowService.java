...
public abstract class  AbstractFlowService {
	protected static Logger LOGGER = LoggerFactory.getLogger(AbstractFlowService.class);

	protected String FlowServer = "localhost:8080/Flow/rest";
    ...
    public AbstractFlowService(){
        this.FlowServer  = connectProperties.getProperty("FlowServer");
    }
    ...
    public AbstractFlowService setWebServicesString(String webServicesString) {
